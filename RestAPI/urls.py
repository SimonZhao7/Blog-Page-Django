...
urlpatterns = [
    ...
    path('CustomUserAPI/search=<str:search_value>/', views.CustomUserAPIView.as_view(), name='CustomUserAPI'),
    path('CustomUserAPI/<int:id>/type=<str:type>/', views.CustomUserAPIView.as_view(), name='CustomUserAPI'),
    ...
    path('UserFollowingAPI/user_id=<int:user_id>/', views.UserFollowingAPIView.as_view(), name='UserFollowingAPI'),
    path('UserFollowingAPI/following_id=<int:following_id>/', views.UserFollowingAPIView.as_view(), name='UserFollowingAPI'),
    ...
    path('UserFriendAPI/user_id=<int:user_id>/', views.UserFriendAPIView.as_view(), name='UserFriendAPI'),
